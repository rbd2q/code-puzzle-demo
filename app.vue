...
div(class="w-screen h-screen")
  div(class="h-2/3 overflow-scroll relative rounded-[2px] border border-b-0 border-[#F3F4F6]" :class="{'!border-[#4EAD69]' : codeState === 'correct', '!border-[#E61739]' : codeState === 'wrong',}")
    ...
    div(class="py-3  bg-[#F3F4F6] rounded-[2px]" :class="{ '!bg-[#FFF2F2]': codeState === 'wrong', '!bg-[#EEF8EA]': codeState === 'correct' }")
